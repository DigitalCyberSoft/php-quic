--TEST--
SOCKS5 TCP control socket stays alive during QUIC connection
--EXTENSIONS--
quic
--SKIPIF--
<?php
...
$logfile = "/tmp/3proxy-test-064-$port.log";
$cfgfile = "/tmp/3proxy-test-064-$port.cfg";
...
// After close, verify proper cleanup
$conn->close();
$conn = null;
gc_collect_cycles();
usleep(50000);
